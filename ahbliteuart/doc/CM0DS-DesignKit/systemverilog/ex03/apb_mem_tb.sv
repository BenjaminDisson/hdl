...
// TO DO - replace APB bus signals with APB interface
...
module APB_mem_tb;
  ...
  APB_mem #( APB_ADDR_WIDTH, APB_DATA_WIDTH, 1 ) mem0 (.iport(iface.slave_mp));
  APB_driver drv0 (.iport(iface.master_mp));
