...
// HOWEVER, you are advised to take a close look at the APB_Stim
// class to see how it has changed to make use of the Component
// base class, as described in the classroom session.
