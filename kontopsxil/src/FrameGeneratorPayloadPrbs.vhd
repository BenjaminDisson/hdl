--   ----------------------------------------------------------------------------------------------
--   Nom du fichier    	: FrameGeneratorPayloadPrbs.vhd  
...
--   13/01/2022         : 4.0   : Benjamin Disson   : RGMII - use a payload MAC PRBS frame from preambule to CRC
...
entity  FrameGeneratorPayloadPrbs  is
port ( 	
    -- Clock et Reset
...
end FrameGeneratorPayloadPrbs;

architecture  rtl  of  FrameGeneratorPayloadPrbs  is
-------------------------------------------------------------------------------
