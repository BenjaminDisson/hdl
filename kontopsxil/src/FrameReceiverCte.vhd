--   ----------------------------------------------------------------------------------------------
--   Nom du fichier    	: FrameReceiverCte.vhd  
...
end FrameReceiverCte;

architecture  rtl  of  FrameReceiverCte  is
-------------------------------------------------------------------------------
...
-------------------------------------------------------------------------------
    ...
    begin
        if (i_arst_n = '0') then
            ...
            --Debug
            if (i_RxEn = '1' ) then--and (s_Rxd_tmp(3) xor i_Rxd(3) = '1' ))  then
                s_DebugDataMov <= '1';
            else
                s_DebugDataMov <= '0';
            end if;
